...
const musica7 = document.getElementById('musica7');
const musica8 = document.getElementById('musica8');
const musica9 = document.getElementById('musica9');
const musica10 = document.getElementById('musica10');
const musica11 = document.getElementById('musica11');
const musica12 = document.getElementById('musica12');
const musica13 = document.getElementById('musica13');
const musica14 = document.getElementById('musica14');
const musica15 = document.getElementById('musica15');
const musica16 = document.getElementById('musica16');
const musica17 = document.getElementById('musica17');
const musica18 = document.getElementById('musica18');
const musica19 = document.getElementById('musica19');
const musica20 = document.getElementById('musica20');

musica1.addEventListener('click', function(){
    console.log(musica1.textContent.split('.'));

    var text = musica1.textContent.split('.');
    localStorage.setItem('valueText', text[0]);
    window.location.href = "disco/disco.html";
})
